        ...
        <main className="relative z-10 w-full max-w-[360px] p-8 m-4 bg-slate-900/70 backdrop-blur-2xl border border-white/10 rounded-[24px] shadow-2xl animate-slide-up">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-slate-400 mt-2">
              Bergabung dengan <span className="text-cyan-400">HealthCareAI</span>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full py-3 pl-12 pr-4 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:bg-white/10 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all text-sm"
            ...
            <div className="relative group">
              ...
              <input
                ...
                value={form.password}
                onChange={handleChange}
                className="w-full py-3 pl-12 pr-12 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:bg-white/10 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all text-sm"
